...
if(descripcionInput) {
    descripcionInput.addEventListener('input', filtrarDescripcion);   
}

// El filtrado del campo título se realiza a través de fetch
if(tituloInput) {
    tituloInput.addEventListener('input', function() {
        const valor = tituloInput.value.toLowerCase();
        ...
        .then(response => response.text())  // la respuesta que devuelve el servidor es un texto (html)
        .then(html => {
