...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="w-100 h-auto border border-black d-flex justify-content-center align-items-start" style={{height: '500px'}}>
        <div className="w-75 border border-black mt-4 d-flex flex-column justify-content-start align-items-start">
          <div className="film-box">
            ...
            <div className="film-info">
              <h2>Oblivion</h2>
              <p>En el año 2073, la Tierra ha sido devastada por una guerra nuclear y los seres humanos han sido evacuados a Marte. Jack Harper (Tom Cruise), 
          ...
          <div className="film-box">
            ...
            <div className="film-info">
              <h2>IT</h2>
              <p>La película cuenta la historia de siete niños marginados del municipio de Derry, Maine (EE. UU.), que se llaman a sí mismos "El Club de los 
          ...
          <div className="film-box">
            ...
            <div className="film-info">
              ...
              <p>La tercera entrega de la saga Harry Potter nos cuenta el transcurso del tercer año del protagonista en el colegio Hogwarts. Al inicio de este año,
                 ...
                 Mientras tanto, Harry intentará entender la razón de las desconcertantes apariciones y desapariciones de su amiga Hermione con la ayuda de Ron y del 
                 gigante Hagrid, que ha asumido un nuevo cargo en Hogwarts como profesor de Cuidado de Criaturas Mágicas.</p>
            </div>
          </div>
          ...
          <div className="film-box">
            ...
            <div className="film-info">
              ...
              <p>El temerario aventurero Peter Quill es objeto de un implacable cazarrecompensas después de robar una misteriosa esfera codiciada por Ronan, un poderoso 
      ...
      <div id="footer" className="w-100 mt-5 border border-black" style={{height: '30px'}}>
